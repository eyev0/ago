...
description: Conducts security reviews, threat modeling, and vulnerability analysis. Use when a task requires security audit, threat assessment, dependency scanning, or auth flow review.
