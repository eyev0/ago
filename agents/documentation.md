...
1. Invoke the `validate-docs-integrity` skill to verify your changes
...
## Quality Gate
Your work is reviewed by **MASTER** during consolidation. Documentation integrity is validated via the `validate-docs-integrity` skill.
