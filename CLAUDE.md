...
- `docs/superpowers/plans/*.{arch,sec,qal,pm}-review.md` — per-role implementation plan review artifacts
- `docs/superpowers/plans/*.review-index.md` — consolidated review summary index
